...
namespace Task25
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            set.Remove(30);
            Console.WriteLine("Size after Remove(30): " + set.Size());
            int[] toKeep = { 20, 40, 60 };
            set.RetainAll(toKeep);
            Console.WriteLine("Size after RetainAll: " + set.Size());
            Console.WriteLine("Remaining elements: " + string.Join(", ", set.ToArray()));
            set.Clear();
            Console.WriteLine("IsEmpty after Clear: " + set.IsEmpty());
        }
    }
}
